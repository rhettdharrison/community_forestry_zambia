...
#| fig-width: 8
#| fig-height: 6
#| fig-cap: "Age of community forests (on 1st January 2025) surveyed by province. The black dots indicate the individual CFs. The boxes represent the 25th and 75th percentile and the 50th percentile is indicated with the black bar. The red dot indicates the mean."
#| fig-cap-location: bottom
...
The number of individual interviews with key stakeholders varied among the CFs. However, we attempted to hold interviews with a CFMG executive member (usually the secretary), the DFO and the community headmen or headwoman in every CF (@tbl-Breakdown_interviews_by_interviewee_role). The same structured interview tool was used for both FGD and individual interviews.
