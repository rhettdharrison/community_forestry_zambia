...
CFM in Zambia is broadly working but has significant room for improvement. On the positive side, a clear majority of communities report that CFM has reduced deforestation, lowered fire frequency, and increased wildlife populations — the core indicators of sustainable forest management. Most communities also recognise livelihood gains from increased employment and income, and enumerator observations confirm that many CFMGs are actively engaged and functioning.

However, governance remains the critical weakness. Many CFMGs have not completed basic legal and administrative processes, financial management infrastructure is often absent, and DFO oversight is infrequent despite being a statutory requirement. A meaningful subset of CFMGs are dormant or struggling, and community feedback is widely inadequate. The enumerator observations — flagging capacity gaps, re-engagement needs, dormant CFMGs, leadership challenges, and elite capture — paint a picture of CFM that is fragile in a significant minority of cases.

Economic transformation is limited and over-reliant on a single revenue stream. Only around one third of CFMGs had received carbon payments at the time of the survey, and the broader potential of forest product enterprises — documented across a wide diversity of NTFPs, timber and agroforestry — remains largely untapped.
...
Communities themselves have a clear understanding of what is and is not working, and their feedback on training needs, monitoring approaches, and areas for improvement provides a practical roadmap for strengthening CFM across Zambia.
