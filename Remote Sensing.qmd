...
Taken together, the remote sensing evidence presents a broadly positive picture of CFM effectiveness. CFM has demonstrably reduced fire disturbance and produced measurable gains in above-ground biomass across both CFA cores and 1 km buffer zones, with no evidence of displacement of pressure into surrounding areas. The possible increase in deforestation in the buffer zones warrants continued monitoring. The very low baseline deforestation rates inside CFAs raises questions over the validity of additionality claims by carbon developers.
:::
...
#| message: false
#| error:   false
#| fig-cap: "Annual fire detection density (detections per km²) per CFA before and after establishment, for CFA cores and 1 km buffer zones. Each point represents one CFA-year. Boxes show median and interquartile range."
#| fig-height: 4
...
#| message: false
#| error:   false
#| tbl-cap: "Linear mixed model results for log-transformed annual fire count before and after CFA establishment."
...
tidy(M_count, effects = "fixed") |>
  ...
  tab_header(
    ...
    subtitle = glue(
      ...
      "CFA variance = {cfmg_count}; residual variance = {resid_count}. ",
...
#| message: false
#| error:   false
#| fig-cap: "Annual fire footprint as a fraction of area before and after CFA establishment, for cores and 1 km buffers. Fire footprint estimated as the sum of scan × track for all detections within each zone-year, divided by zone area. Each point represents one CFMG-year. Boxes show median and interquartile range."
#| fig-height: 4
...
#| message: false
#| error:   false
#| tbl-cap: "Gamma GLMM results for annual fire footprint fraction before and after CFA establishment."
...
#| message: false
#| error:   false
#| tbl-cap: "Linear mixed model results for log-transformed annual total FRP per km² before and after CFA establishment."
...
#| message: false
#| error:   false
#| fig-cap: "Annual tree cover loss (% of area) in CFA cores and 1 km buffer zones before and after CFA establishment. Loss derived from Hansen GFC 2024 lossyear data (2014–2024). Each point represents one CFMG-year. Boxes show median and interquartile range."
#| fig-height: 4
...
#| message: false
#| error:   false
#| tbl-cap: "Linear mixed model results for log-transformed annual tree cover loss rate in CFA cores and buffer zones before and after establishment."
...
#| message: false
#| error:   false
#| fig-cap: "Mean above ground biomass (Mg/ha) per CFA before and after establishment, for CFA cores and 1 km buffer zones. Values are annual means from 2018–2024; core values are area-weighted across polygons. Each point represents one CFA-year. Boxes show median and interquartile range."
#| fig-height: 4
...
#| message: false
#| error:   false
#| tbl-cap: "Linear mixed model results for mean above ground biomass in CFA cores and buffer zones before and after establishment."
...
tidy(M_agb, effects = "fixed") |>
  ...
  tab_header(
    ...
    subtitle = glue(
      "Linear mixed model with random intercept for CFA. ",
      "Fixed effects: period (ref = Before), zone (ref = Core), their interaction, and governance index. ",
      "A significant After × Buffer interaction indicates leakage. ",
      "CFA variance = {cfmg_agb}; residual variance = {resid_agb}. ",
